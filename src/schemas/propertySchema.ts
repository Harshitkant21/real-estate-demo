...
export const DeveloperSchema = z.object({
  ...
  upcomingLaunches: z.number().optional(),
  pipelineLaunches: z.number().optional(),
  portfolioYield: z.number(),
  deliveryScore: z.number(),
  insights: z.array(z.string()).optional(),
  flagshipProject: z.string().optional(),
  flagshipCommunities: z.array(z.string()).optional(),
  escrowCompliant: z.boolean().optional(),
